...
parser.add_argument('--source_npy_dirpath', type=str, default='/mnt16t_ext/dinghaoyu/FLARE24/datasets/CT/ST_CT_3d')
parser.add_argument('--target_npy_dirpath', type=str, default='/mnt16t_ext/dinghaoyu/FLARE24/datasets/MR/Training/ST_MR_3d')
parser.add_argument('--save_nii_dirpath', type=str, default='/mnt16t_ext/dinghaoyu/FLARE24/datasets/CT/CT2MR_image')
